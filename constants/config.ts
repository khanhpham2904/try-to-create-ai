...
const getBaseUrl = () => {
  ...
  return 'https://chat-app-with-ai-ajhybzeme8gtbafm.eastasia-01.azurewebsites.net';
};

// Improved fallback URLs with proper protocols
export const FALLBACK_URLS = [
  'https://chat-app-with-ai-ajhybzeme8gtbafm.eastasia-01.azurewebsites.net', // for production
  'http://localhost:8000', // for local developments
